    ...
    <div className="cart">
      ...
      <div className="cart__items">
        <div className="cart__item">
          <div className="cart__item-img">
            <img className="pizza-block__image" src="https://dodopizza.azureedge.net/static/Img/Products/Pizza/ru-RU/ec29465e-606b-4a04-a03e-da3940d37e0e.jpg" alt="Pizza"/>
          </div>
      ...
      <div className="cart__bottom">
        <div className="cart__bottom-details">
          ...
          <span> Сумма заказа: <b>1485 ₽</b> </span>
        </div>
